...
import { GameClock } from "../../shared/core/game-loop";
import { worldRuntime } from "../../shared/world/WorldLoader";
import { calculateCurrentWeight, checkWeightPenalties } from "../../shared/inventory/types";
import { getXpRequired } from "../../shared/jobs/types";
            ...
            <div className="absolute top-4 left-4 bg-[#0d1117dd] border border-[#30363d] p-3 shadow-2xl backdrop-blur-sm w-64 z-10 pointer-events-auto">
              <div className="flex justify-between items-start border-b border-[#30363d] pb-2 mb-2">
                ...
                <div className="flex gap-1.5 mt-2">
                  <button
                    onClick={() => attackTarget(selectedEntityId!)}
                    className="text-[10px] bg-red-900/30 hover:bg-red-800/60 border border-red-500/30 text-rose-200 px-2.5 py-1 font-bold uppercase transition-all"
                  >
                    ⚔️ Attack
                  </button>
                  <button
                    onClick={() => selectEntity(null)}
                    className="text-slate-400 hover:text-white text-[10px] bg-[#161b22] border border-[#30363d] px-2.5 py-1 uppercase transition-colors"
                  >
                    Clear
                  </button>
                </div>
